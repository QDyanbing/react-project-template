...
export default {
  get<TData, TResult>(url: string, data?: TData, options?: RequestOptions) {
    return send<TData, TResult>('GET', url, data, options);
  },
  post<TData, TResult>(url: string, data?: TData, options?: RequestOptions) {
    return send<TData, TResult>('POST', url, data, options);
  },
  put<TData, TResult>(url: string, data?: TData, options?: RequestOptions) {
    return send<TData, TResult>('PUT', url, data, options);
  },
  delete<TData, TResult>(url: string, data?: TData, options?: RequestOptions) {
